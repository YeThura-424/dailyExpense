<template>
  <!-- <div class="z-10"> -->
  <div class="nav-wrapper bg-[#fff] w-full fixed bottom-0 rounded-t-lg p-3 m-w-[56px]">
    <div class="nav-link-container flex justify-between items-center relative">
      <div class="flex gap-x-10">
        <nuxt-link to="/">
          <span class="nav-link-item">
            <Icon name="ion:md-home" :class="[
              'text-3xl',
        ...
        <nuxt-link to="/transaction">
          <span class="nav-link-item">
            <Icon name="ion:arrow-swap" :class="[
              'text-3xl',
    ...
    <div
      ...
      <Icon :name="openMenu ? 'ion:close-circled' : 'ion:plus-circled'" class="text-6xl text-[#7F3DFF]"
