  ...
  <div class="main-wrapper" v-if="expenseData">
    <div class="bg-[#FD3C4A] p-3 rounded-b-[40px] relative">
      <div class="main-header">
        <!-- show-delete @delete="deleteAction" -->
        <MobilePageHeader title="Expense Detail" icon-color="text-white" @back="backAction" />
      </div>
    ...
    <div class="main-info px-4">
      ...
      <div class="pb-4">
        <button type="button" @click="editExpense"
...
const editExpense = () => {
  navigateTo(`/expense/update/${expenseId}`);
}
