    ...
    <div class="px-4 pt-5 pb-[78px]">
      <div class="profile-info-wrapper flex items-center gap-x-3">
        <div class="profile-image rounded-full border-2 border-[#7F3DFF]">
          <img :src="user?.image ?? '/images/userprofile.png'" alt="" class="w-20 h-20 rounded-full p-1" />
        </div>
        <div class="user-info flex justify-between items-center gap-x-20">
          <div class="profile-user-info">
            <p class="text-base text-[#91919F]">Username</p>
            <h1 class="text-xl text-[#161719] capitalize font-semibold line-clamp-1">
              {{ user.name }}
            </h1>
          </div>
      ...
      <div class="profile-modules-wrapper bg-white rounded-[35px] mt-8">
        ...
        <nuxt-link to="/account">
          <div class="account-section flex items-center gap-x-3 border-b border-[#eee] px-4 py-4">
        ...
        <!-- logout  -->
        <div @click.prevent="Logout" class="account-section flex items-center gap-x-3 border-b border-[#eee] px-4 py-4">
          <div class="account-logo w-14 h-14 bg-[#FFE2E4] rounded-2xl flex justify-center items-center">
